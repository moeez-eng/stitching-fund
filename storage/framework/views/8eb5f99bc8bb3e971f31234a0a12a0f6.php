            ...
            onmouseout="this.style.transform='translateY(0)'">
                ...
                <div style="position: relative; display: flex; justify-content: space-between; align-items: center; padding: 1.5rem; background: rgba(0, 0, 0, 0.3);">
                    <div style="display: flex; gap: 1rem; align-items: center;">
                        ...
                        <div>
                            <div style="font-weight: 700; font-size: 1.1rem;"><?php echo e($userName); ?></div>
                            <div style="opacity: 0.7; font-size: 0.85rem;"><?php echo e($wallet->investor->agency->name ?? 'No Agency'); ?></div>
                        </div>
                    </div>

                    <span style="padding: 0.4rem 0.8rem; border-radius: 0.5rem; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; background: rgba(<?php echo e($statusColor == '#22c55e' ? '34, 197, 94' : ($statusColor == '#f59e0b' ? '245, 158, 11' : '239, 68, 68')); ?>, 0.2); color: <?php echo e($statusColor == '#22c55e' ? '#86efac' : ($statusColor == '#f59e0b' ? '#fde68a' : '#fca5a5')); ?>;">
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; padding: 1.5rem; background: rgba(0, 0, 0, 0.25);">
                    <div style="background: rgba(255, 255, 255, 0.05); border-radius: 0.75rem; padding: 1.2rem; text-align: center;">
                        ...
                        <div style="font-size: 1.5rem; font-weight: 700;">PKR <?php echo e(number_format($lifetimeDeposited, 0, ',', ',')); ?></div>
                    </div>
                    <div style="background: rgba(255, 255, 255, 0.05); border-radius: 0.75rem; padding: 1.2rem; text-align: center;">
                        <div style="font-size: 0.7rem; opacity: 0.7; text-transform: uppercase;">Active Invested</div>
                        <div style="font-size: 1.5rem; font-weight: 700;">PKR <?php echo e(number_format($activeInvested, 0, ',', ',')); ?></div>
                    </div>
                    <div style="background: rgba(255, 255, 255, 0.05); border-radius: 0.75rem; padding: 1.2rem; text-align: center;">
                        <div style="font-size: 0.7rem; opacity: 0.7; text-transform: uppercase;">Total Returned</div>
                        <div style="font-size: 1.5rem; font-weight: 700;">PKR <?php echo e(number_format($totalReturned, 0, ',', ',')); ?></div>
                    </div>
                </div>
                ...
                <div style="display: flex; gap: 1rem; padding: 1.5rem; background: rgba(0, 0, 0, 0.25);">
                    ...
                    <button onclick="openWithdrawModal(<?php echo e($wallet->id); ?>, '<?php echo e(auth()->user()->name); ?>', <?php echo e(auth()->id()); ?>, <?php echo e($availableBalance); ?>)" style="flex: 1; padding: 1.2rem; background: linear-gradient(135deg, #6b46c1, #553c9a); color: white; border: none; border-radius: 0.75rem; font-weight: 600; cursor: pointer;">
                        Request Withdraw
                    </button>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php echo $__env->make('filament::layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\stitching-fund\resources\views/filament/wallet/pages/simple-wallet.blade.php ENDPATH**/ ?>