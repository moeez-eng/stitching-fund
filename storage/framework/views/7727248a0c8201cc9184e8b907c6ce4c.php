    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="text-align: center;">
                <a href="<?php echo e($registerUrl); ?>" class="button">Accept Invitation</a>
            </p>
            
            <p><small>This invitation will expire on: <?php echo e($invitation->expires_at->format('F j, Y')); ?></small></p>
